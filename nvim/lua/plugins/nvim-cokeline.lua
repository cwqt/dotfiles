...
function M.setup()
  ...
  local colors = {
    activeBg = 'NONE',
    purple = oxocarbon.purple,
    light_purple = oxocarbon.lightBlue,
    gray = oxocarbon.grey40,
    red = oxocarbon.hotPink,
    green = oxocarbon.green,
    yellow = oxocarbon.black,
  }
  ...
  cokeline.setup {
    ...
    default_hl = {
      ...
      bg = function(buffer)
        return buffer.is_focused and colors.activeBg or 'NONE'
      end,
